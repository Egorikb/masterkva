...
async def plugins_panda_chat(request: ChatRequest):
    """Reuse the plugins_api panda logic."""
    from deeptutor.api.routers.plugins_api import panda_chat
    return await panda_chat(request)
